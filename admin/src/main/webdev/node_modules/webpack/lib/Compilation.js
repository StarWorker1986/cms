		...
		for(let i = 0; i < this.chunks.length; i++) {
			...
			try {
				...
				if(this.cache && this.cache[cacheName] && this.cache[cacheName].hash === usedHash) {
				    ...
				    const noParseRule = this.options.module && this.options.module.noParse;
				    if(noParseRule) {
				        source = new ConcatSource();
				        chunk.mapModules(function(module) {
				            if(module.originalSource() && module.shouldPreventParsing(noParseRule, module.request)) {
				                source.add(module.originalSource().source() + '\n');
