(function (global, factory) {
	if (typeof define === "function" && define.amd) {
		define(["exports", "admin/common/utils/ObjectUtils"], factory);
	} else if (typeof exports !== "undefined") {
		factory(exports, require("admin/common/utils/ObjectUtils"));
	} else {
		var mod = {
			exports: {}
		};
	...
	var idGenerator = _ObjectUtils2.default.getIdGenerator("Dropdown");
		...
		_createClass(NavbarDropdown, [{
			...
			value: function render() {
				var toggleId = this.toggle.id || idGenerator.nextId(),
				    toggleIconCls = _ObjectUtils2.default.join(["cms-icon fa", this.toggle.iconCls], ' '),
				    toggleTextCls = _ObjectUtils2.default.join(["badge", this.toggle.textCls], ' '),
				    menuHeaderIconCls = _ObjectUtils2.default.join(["cms-icon fa", this.menu.header.iconCls], ' ');
